...
export const AI_PRODUCT_IMAGE_VARIANTS: Record<string, string[]> = {
  ...
  eggs: [
    'https://images.unsplash.com/photo-1569288052389-dac9b01c9c05', // eggs in carton
    'https://images.unsplash.com/photo-1498654077810-12c21d4d6dc3', // eggs in bowl
    'https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f', // brown eggs basket
  ],

  // Produce - vegetables arrangement (no people)
  produce: [
    'https://images.unsplash.com/photo-1540420773420-3366772f4999', // vegetable spread
    'https://images.unsplash.com/photo-1590779033100-9f60a05a013d', // fresh produce pile
    'https://images.unsplash.com/photo-1610348725531-843dff563e2c', // colorful vegetables
  ],

  // Vegetables - market vegetables (no people)
  vegetables: [
    'https://images.unsplash.com/photo-1566385101042-1a0aa0c1268c', // market vegetables
    'https://images.unsplash.com/photo-1597362925123-77861d3fbac7', // garden vegetables
    'https://images.unsplash.com/photo-1518843875459-f738682238a6', // vegetable basket
  ],

  // Fruit - fresh fruit display (no people)
  fruit: [
    'https://images.unsplash.com/photo-1619566636858-adf3ef46400b', // fruit arrangement
    'https://images.unsplash.com/photo-1610832958506-aa56368176cf', // mixed fruits
    'https://images.unsplash.com/photo-1568702846914-96b305d2uj8b', // fruit bowl
  ],

  // Baked goods - breads and pastries (no people)
  baked_goods: [
    'https://images.unsplash.com/photo-1509440159596-0249088772ff', // artisan breads
    'https://images.unsplash.com/photo-1555507036-ab1f4038808a', // pastries display
    'https://images.unsplash.com/photo-1517433670267-30f4906e6f73', // fresh baked goods
  ],

  // Bread - sourdough loaves (no people)
  bread: [
    'https://images.unsplash.com/photo-1549931319-a545dcf3bc73', // rustic loaves
    'https://images.unsplash.com/photo-1585478259715-876acc5be8fc', // bread slices
    'https://images.unsplash.com/photo-1509440159596-0249088772ff', // artisan bread
  ],

  // Meat - farm meats (no people)
  meat: [
    'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f', // meat cuts
    'https://images.unsplash.com/photo-1558030006-450675393462', // butcher cuts
    'https://images.unsplash.com/photo-1602470520998-f4a52199a3d6', // fresh meat
  ],

  // Beef - cuts of beef (no people)
  beef: [
    'https://images.unsplash.com/photo-1603048297172-c92544798d5a', // beef cuts
    'https://images.unsplash.com/photo-1588168333986-5078d3ae3976', // steak cuts
    'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f', // raw beef
  ],

  // Honey - jars and honeycomb (no people)
  honey: [
    'https://images.unsplash.com/photo-1587049352846-4a222e784d38', // honey jars
    'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62', // honeycomb
    'https://images.unsplash.com/photo-1471943311424-646960669fbc', // honey dipper
  ],

  // Flowers - bouquets and blooms (no people)
  flowers: [
    'https://images.unsplash.com/photo-1490750967868-88aa4486c946', // flower field
    'https://images.unsplash.com/photo-1487530811176-3780de880c2d', // bouquet
    'https://images.unsplash.com/photo-1455659817273-f96807779a8a', // cut flowers
  ],

  // Pumpkins - autumn display (no people)
  pumpkins: [
    'https://images.unsplash.com/photo-1509622905150-fa66d3906e09', // pumpkin patch
    'https://images.unsplash.com/photo-1570586437263-ab629fccc818', // pumpkin display
    'https://images.unsplash.com/photo-1506917728037-b6af01a7d403', // autumn pumpkins
  ],

  // Dairy - milk and cheese (no people)
  dairy: [
    'https://images.unsplash.com/photo-1628088062854-d1870b4553da', // dairy products
    'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d', // cheese wheels
    'https://images.unsplash.com/photo-1550583724-b2692b85b150', // milk bottles
  ],

  // Preserves - jams and canned goods (no people)
  preserves: [
    'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5', // mason jars
    'https://images.unsplash.com/photo-1563805042-7684c019e1cb', // jam jars
    'https://images.unsplash.com/photo-1597227301620-4c5e33e5a729', // preserves shelf
  ],

  // Plants - potted plants and seedlings (no people)
  plants: [
    'https://images.unsplash.com/photo-1416879595882-3373a0480b5b', // greenhouse plants
    'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a', // seedlings
    'https://images.unsplash.com/photo-1466692476868-aef1dfb1e735', // potted plants
  ],

  // Crafts - handmade goods (no people)
  crafts: [
    'https://images.unsplash.com/photo-1452860606245-08befc0ff44b', // handmade items
    'https://images.unsplash.com/photo-1558618666-fcd25c85cd64', // craft supplies
    'https://images.unsplash.com/photo-1544967082-d9d25d867d66', // artisan crafts
  ],

  // Berries - fresh berries (no people)
  berries: [
    'https://images.unsplash.com/photo-1464965911861-746a04b4bca6', // mixed berries
    'https://images.unsplash.com/photo-1498557850523-fd3d118b962e', // blueberries
    'https://images.unsplash.com/photo-1464965911861-746a04b4bca6', // berry basket
  ],

  // Apples - fresh apples (no people)
  apples: [
    'https://images.unsplash.com/photo-1570913149827-d2ac84ab3f9a', // red apples
    'https://images.unsplash.com/photo-1567306226416-28f0efdc88ce', // apple basket
    'https://images.unsplash.com/photo-1576179635662-9d1983e97e1e', // green apples
  ],

  // Tomatoes - vine tomatoes (no people)
  tomatoes: [
    'https://images.unsplash.com/photo-1592921870789-04563d55041c', // vine tomatoes
    'https://images.unsplash.com/photo-1561136594-7f68413baa99', // heirloom tomatoes
    'https://images.unsplash.com/photo-1546094096-0df4bcaaa337', // cherry tomatoes
  ],

  // Corn - fresh corn (no people)
  corn: [
    'https://images.unsplash.com/photo-1551754655-cd27e38d2076', // corn cobs
    'https://images.unsplash.com/photo-1605524927712-5e1f4f0e9a5b', // fresh corn
    'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37', // corn harvest
  ],

  // Mixed/General - farmstand scenes (no people)
  mixed: [
    'https://images.unsplash.com/photo-1595855759920-86582396756a', // produce stand
    'https://images.unsplash.com/photo-1488459716781-31db52582fe9', // market produce
    'https://images.unsplash.com/photo-1542838132-92c53300491e', // farm market
  ],

  // Default - wooden crates, barn, farm scenes (no people)
  default: [
    'https://images.unsplash.com/photo-1595855759920-86582396756a', // farm produce
    'https://images.unsplash.com/photo-1500076656116-558758c991c1', // barn exterior
    'https://images.unsplash.com/photo-1464226184884-fa280b87c399', // farm landscape
  ],
};
...
export const FALLBACK_IMAGE_URLS: Record<FallbackImageKey, string[]> = {
  eggs_fresh_carton_closeup: [
    'https://images.unsplash.com/photo-1569288052389-dac9b01c9c05',
  ...
  mixed_produce_colorful: [
    'https://images.unsplash.com/photo-1540420773420-3366772f4999', // vegetable spread
    'https://images.unsplash.com/photo-1590779033100-9f60a05a013d', // fresh produce
    'https://images.unsplash.com/photo-1610348725531-843dff563e2c', // colorful vegetables
  ],
  jars_of_jam_on_table: [
    'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5',
    'https://images.unsplash.com/photo-1563805042-7684c019e1cb',
    'https://images.unsplash.com/photo-1597227301620-4c5e33e5a729',
  ],
  fresh_herbs_bundle: [
  ...
  pumpkin_autumn_display: [
    'https://images.unsplash.com/photo-1509622905150-fa66d3906e09',
    'https://images.unsplash.com/photo-1570586437263-ab629fccc818',
  ...
  corn_fresh_harvest: [
    ...
    'https://images.unsplash.com/photo-1605524927712-5e1f4f0e9a5b',
 ...
 */
export const FAILSAFE_FALLBACK_IMAGE = 'https://images.unsplash.com/photo-1500076656116-558758c991c1&v=2';
