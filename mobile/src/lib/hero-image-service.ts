...
const THEME_IMAGE_VARIANTS: Record<HeroImageTheme, string[]> = {
  ...
  fruit: [
    ...
    'https://images.unsplash.com/photo-1464965911861-746a04b4bca6', // berries
  ],
  honey: [
  ...
  herbs: [
    'https://images.unsplash.com/photo-1416879595882-3373a0480b5b', // herb plants
    'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a', // herb seedlings
    'https://images.unsplash.com/photo-1466692476868-aef1dfb1e735', // potted herbs
  ],
  preserves: [
