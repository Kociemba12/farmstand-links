 ...
 * Using w=800&q=85&auto=format&fit=crop for Unsplash:
 * – w=800 is sufficient for the 117pt category tiles at 3× DPR (351px physical)
 * – q=85 gives near-lossless quality without excess payload
 * – auto=format serves WebP/AVIF on supporting clients
 * – fit=crop keeps the focal crop matching contentFit="cover"
 */
export const CATEGORY_IMAGES: Record<string, string> = {
  eggs: 'https://images.unsplash.com/photo-1518569656558-1f25e69d93d7?w=800&q=85&auto=format&fit=crop',
  meat: 'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=800&q=85&auto=format&fit=crop',
  flowers: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=800&q=85&auto=format&fit=crop',
  honey: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=800&q=85&auto=format&fit=crop',
  produce: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=800&q=85&auto=format&fit=crop',
  baked_goods: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&q=85&auto=format&fit=crop',
  dairy: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=800&q=85&auto=format&fit=crop',
  berries: 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=800&q=85&auto=format&fit=crop',
  upick: 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=800&q=85&auto=format&fit=crop',
  pumpkins: 'https://images.unsplash.com/photo-1509622905150-fa66d3906e09?w=800&q=85&auto=format&fit=crop',
  seasonal: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=800&q=85&auto=format&fit=crop',
  herbs: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=85&auto=format&fit=crop',
  preserves: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=800&q=85&auto=format&fit=crop',
  plants: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=800&q=85&auto=format&fit=crop',
  crafts: 'https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=800&q=85&auto=format&fit=crop',
};
  ...
  for (const item of allItems) {
    ...
    for (const keyword of keywords) {
      ...
      if (!lowerKeyword.includes(' ')) {
        // Use cached regex — avoids creating new RegExp on every farm/item/keyword combo
        if (getKeywordRegex(lowerKeyword).test(lowerItem)) {
          return true;
        }
      } else {
...
// Module-level regex cache — built once, reused on every chip tap.
// Creating `new RegExp()` inside the filter loop (500 farms × 8 items × 15 keywords)
// was generating 60,000+ regex objects per tap and crashing the Simulator.
const _keywordRegexCache = new Map<string, RegExp>();
function getKeywordRegex(keyword: string): RegExp {
  let re = _keywordRegexCache.get(keyword);
  if (!re) {
