...
function KPICard({ title, value, icon, color, subtitle, size = 'normal' }: KPICardProps) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Conversion Funnel */}
        <SectionCard title="Conversion Funnel (7 Days)" delay={100}>
          <View className="py-2">
            <FunnelStage
              label="Views"
        ...
        {/* Reviews Summary */}
        <SectionCard title="Reviews" delay={300}>
