...
import MapView, { Marker, Region, MapPressEvent, MapType } from 'react-native-maps';
import {
  MapPin,
  Crosshair,
  Search,
...
export interface AddressMapPickerProps {
  ...
  // Map display type (admin-only feature, defaults to 'standard')
  mapType?: MapType;

  // Called when admin taps Standard/Satellite toggle (only shown when provided)
  ...
  return (
    <View className="rounded-xl overflow-hidden border border-gray-200 mt-4">
      ...
      <View style={styles.mapContainer}>
        ...
        {/* Standard / Satellite toggle — only rendered when admin passes onMapTypeChange */}
        {onMapTypeChange && (
          <View
            style={[styles.mapTypeControl, { zIndex: 10, elevation: 10 }]}
            pointerEvents="box-none"
          >
            <View style={styles.mapTypeSegment} pointerEvents="auto">
              <Pressable
              ...
              >
                <Text style={[
                  styles.mapTypeLabel,
                  mapType === 'standard' ? styles.mapTypeLabelActive : styles.mapTypeLabelInactive,
                ]}>
                  Standard
                </Text>
              </Pressable>
              ...
              >
                <Text style={[
                  styles.mapTypeLabel,
                  mapType === 'satellite' ? styles.mapTypeLabelActive : styles.mapTypeLabelInactive,
                ]}>
                  Satellite
                </Text>
              </Pressable>
